...
//This function is called when the player opens the gossip menuboolclass custom_gossip_codebox : public UnknownScript
{
public:
    custom_gossip_codebox() : UnknownScript("custom_gossip_codebox") { }

    bool GossipSelectWithCode(Player* player, Creature* creature, uint32 sender, uint32 action, const char* sCode)
    {
