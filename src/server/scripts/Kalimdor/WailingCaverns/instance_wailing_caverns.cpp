...
public:
    ...
    struct instance_wailing_caverns_InstanceMapScript : public ScriptedInstance
    {
        instance_wailing_caverns_InstanceMapScript(Map* pMap) : ScriptedInstance(pMap) {Initialize();};
