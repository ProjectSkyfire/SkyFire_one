...
public:
    ...
    struct instance_temple_of_ahnqiraj_InstanceMapScript : public ScriptedInstance
    {
        instance_temple_of_ahnqiraj_InstanceMapScript(Map *map) : ScriptedInstance(map) {Initialize();};
