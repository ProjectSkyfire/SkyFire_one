...
bool GossipHello_npc_braug_dimspirit(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_braug_dimspirit(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
