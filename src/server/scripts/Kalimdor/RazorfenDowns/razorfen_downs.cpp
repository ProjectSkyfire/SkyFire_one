...
bool GossipHello_npc_henry_stern (Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_henry_stern (Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
