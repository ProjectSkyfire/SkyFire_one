...
public:
    ...
    struct instance_blackfathom_deeps_InstanceMapScript : public ScriptedInstance
    {
        instance_blackfathom_deeps_InstanceMapScript(Map* pMap) : ScriptedInstance(pMap) {Initialize();};
