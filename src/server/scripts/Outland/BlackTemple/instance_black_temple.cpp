...
public:
    ...
    struct instance_black_temple_InstanceMapScript : public ScriptedInstance
    {
        instance_black_temple_InstanceMapScript(Map* pMap) : ScriptedInstance(pMap) {Initialize();};
