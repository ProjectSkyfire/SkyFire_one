...
bool GossipHello_npc_spirit_of_olum(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_spirit_of_olum(Player* pPlayer, Creature* /*creature*/, uint32 /*uiSender*/, uint32 uiAction)
{
