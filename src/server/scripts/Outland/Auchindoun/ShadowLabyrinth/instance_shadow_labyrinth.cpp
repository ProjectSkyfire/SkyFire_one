...
public:
    ...
    struct instance_shadow_labyrinth_InstanceMapScript : public ScriptedInstance
    {
        instance_shadow_labyrinth_InstanceMapScript(Map *map) : ScriptedInstance(map) {Initialize();};
...
// ToDo Move creature_fel_overseerAI to a seperate fileclass mob_fel_overseer : public CreatureScript
{
public:
    mob_fel_overseer() : CreatureScript("mob_fel_overseer") { }
