...
public:
    ...
    bool GossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        switch (sender)
        {
            case GOSSIP_SENDER_MAIN:            SendDefaultMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_CLASSTRAIN:  SendClassTrainerMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_PROFTRAIN:   SendProfTrainerMenu(player, creature, action); break;
        }
        return true;
    }
...
public:
    ...
    bool GossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        switch (sender)
        {
            ...
            case GOSSIP_SENDER_SEC_CLASSTRAIN:  SendClassTrainerMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_PROFTRAIN:   SendProfTrainerMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_BATTLEINFO:  SendBattleMasterMenu(player, creature, action); break;
        }
        return true;
    }
...
public:
    ...
    bool GossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        {
            case GOSSIP_SENDER_MAIN:              SendDefaultMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_BANK:          SendBankMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_INN:           SendInnMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_STABLEMASTER:  SendStableMasterMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_GEMMERCHANT:   SendGemMerchantMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_MAILBOX:       SendMailboxMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_PROFTRAIN:     SendProfTrainerMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_BATTLEINFO:    SendBattleMasterMenu(player, creature, action); break;
        }
        return true;
...
public:
    ...
    bool GossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        {
            case GOSSIP_SENDER_MAIN:                SendDefaultMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_AUCTIONHOUSE:    SendAuctionhouseMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_INN:             SendInnMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_CLASSTRAIN:      SendClassTrainerMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_PROFTRAIN:       SendProfTrainerMenu(player, creature, action); break;
            case GOSSIP_SENDER_SEC_BATTLEINFO:      SendBattleMasterMenu(player, creature, action); break;
