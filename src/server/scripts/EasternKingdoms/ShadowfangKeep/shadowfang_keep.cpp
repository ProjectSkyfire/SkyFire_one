...
bool GossipHello_npc_shadowfang_prisoner(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_shadowfang_prisoner(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
