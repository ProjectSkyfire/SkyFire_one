...
bool GossipHello_npc_deathly_usher(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_deathly_usher(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
...
bool GossipHello_npc_fallen_hero_of_horde(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_fallen_hero_of_horde(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
    switch (uiAction)
    {
