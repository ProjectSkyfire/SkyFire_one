...
bool GossipHello_npc_blood_knight_dawnstar(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_blood_knight_dawnstar(Player* pPlayer, Creature* /*creature*/, uint32 /*uiSender*/, uint32 uiAction)
{
...
bool GossipHello_npc_budd_nedreck(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_budd_nedreck(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
...
bool GossipHello_npc_rathis_tomber(Player* pPlayer, Creature* creature)
{
    if (creature->isQuestGiver())
        pPlayer->PrepareQuestMenu(creature->GetGUID());
...
bool GossipSelect_npc_rathis_tomber(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
