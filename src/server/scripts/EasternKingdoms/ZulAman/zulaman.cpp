...
bool GossipHello_npc_zulaman_hostage(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_zulaman_hostage(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
