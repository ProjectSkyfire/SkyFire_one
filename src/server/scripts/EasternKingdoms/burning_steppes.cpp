...
bool GossipHello_npc_ragged_john(Player* pPlayer, Creature* creature)
{
...
bool GossipSelect_npc_ragged_john(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
{
    switch (uiAction)
    {
