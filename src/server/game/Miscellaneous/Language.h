...
//                                      = 710, not used
    ...
    LANG_OPVP_EP_LOSE_NORTHPASS_H       = 10041,
    LANG_OPVP_EP_LOSE_NORTHPASS_A       = 10042,
    LANG_OPVP_EP_LOSE_EASTWALL_H        = 10043,
    LANG_OPVP_EP_LOSE_EASTWALL_A        = 10044,
    LANG_OPVP_EP_LOSE_CROWNGUARD_H      = 10045,
    LANG_OPVP_EP_LOSE_CROWNGUARD_A      = 10046,
    LANG_OPVP_EP_LOSE_PLAGUEWOOD_H      = 10047,
    LANG_OPVP_EP_LOSE_PLAGUEWOOD_A      = 10048,
    // opvp si
