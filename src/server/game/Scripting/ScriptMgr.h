...
public: /* Initialization */
    ...
    //event handlers
        ...
        bool GossipHello (Player * pPlayer, Creature* creature);
        bool GossipSelect(Player* pPlayer, Creature* creature, uint32 uiSender, uint32 uiAction);
        bool GossipSelectWithCode(Player* pPlayer, Creature* creature, uint32 uiSender, uint32 uiAction, const char* sCode);
        ...
        bool QuestAccept(Player* pPlayer, Creature* creature, Quest const* pQuest);
        bool QuestSelect(Player* pPlayer, Creature* creature, Quest const* pQuest);
        bool QuestComplete(Player* pPlayer, Creature* creature, Quest const* pQuest);
        bool ChooseReward(Player* pPlayer, Creature* creature, Quest const* pQuest, uint32 opt);
        uint32 NPCDialogStatus(Player* pPlayer, Creature* creature);
